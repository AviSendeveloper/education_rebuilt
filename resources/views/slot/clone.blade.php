                  ...
                  <div class="tabset">
                     ...
                     <div class="tab-panels">
                        <section id="marzen" class="tab-panel">
                           <div class="row">
                              <form action="/clone-design-publish" method="post">
                                 @csrf
         ...
         <ul class="nav nav-tabs member-sidebar--menu">
            <li id="member-sidebar--menu-signupsid" class="active" style="float: none !important;">
               <a href="#a"
                  data-toggle="tab">
                  <div class="menu-icon">
                     <svg version="1.1" x="0px" y="0px" width="22px" height="36px"
               ...
               <div class="tab-pane active" id="a">
                  <div id="memPgCenter" class="member-blocks--maincontent-wide">
                     <div id="wizardView" class="kaluscope">
                        <div id="signupWizardContainer" class="l-wizard row kaluscope">
                           <div class="col-xs-12">
                           ...
                           <form action="/modify-design-publish" method="post">
                              ...
                              <div id="Lon" class="tabcontent" style="display: none;">
                                 <div id="wizardStep1" class="l-wizard-step-1 kaluscope">
                                    ...
                                    <div class="form-horizontal">
                                       <div class="form-group feedback-group">
                                          <label id="grouplabel" for="groupinputfield" class="col-xs-2 control-label text-left kalubinding">Group</label>
                                          <div class="col-xs-10">
                                                ...
                                                <div class="row">
                                                   <div class="col-xs-11">
                                                      <div class="w1-max-width-480 pull-left">
                                                         ...
                                                         <?php $details = group::grouping()?>
                                                         @if($details == null)
                                                         <select class="form-control inline-field pull-left w1-max-width-480 kalupristine kaluuntouched kaluvalid kaluempty" id="selectgroup" title="Select a group" name="group">
                                                         ...
                                                         <select class="form-control inline-field pull-left w1-max-width-480 kalupristine kaluuntouched kaluvalid kaluempty" id="selectgroup" title="Select a group" name="group">
                                                            ...
                                                            <option value="{{$detail['group']}}">{{$detail['group']}}</option>
                                                            @endforeach
                                                         </select>
                                                         @endif
                                                      </div>
                                                      <div class="w1-pad-left-10 pull-left">
                                                         <span type="button" name="addAddress" class="w1-orange-plus-btn" kaluclick="w1.changeGroup(-1)" popover-enable="true" uib-popover="Add a New Group" popover-placement="top" popover-trigger="mouseenter" popover-popup-delay="300">
                                          ...
                                          <div class="col-xs-10">
                                             <span>
                                                <div class="row">
                                                            ...
                                                            <div class="form-group w1-margin-bottom-0">
                                                               <div class="row">
                                                                  <div class="col-md-6 col-sm-12">
                                                                     <input class="form-control" type="text" value="General" name="category" readonly="">
                                                                  </div>
                                                                  <div class="col-md-6 col-sm-12">
                                                                     <select class="selectpicker show-tick form-control inline-field kalupristine kaluuntouched kaluvalid kalunot-empty" id="selecttype" title="Select a Type">
                                                   ...
                                                   <div class="col-md-16">
                                                      <div class="w1-pad-left-10 pull-left">
                                                         <select class="form-control" name="cause" required="required">
                                                            <option data-original-index="2" value="Animals & Pets"><a tabindex="0" class="" data-tokens="null"><span
                                                               class="text">Animals &amp;
                                                               Pets</span><span class="glyphicon glyphicon-ok check-mark"></span></a>
                                                            </option>
                                                            <option data-original-index="3" value="Arts & Culture"><a tabindex="0" class="" data-tokens="null"><span
                                                               class="text">Arts &amp;
                                                               Culture</span><span
                                                                  class="glyphicon glyphicon-ok check-mark"></span></a>
                                                            </option>
                                                            <option data-original-index="4" value="Business"><a tabindex="0" class="" data-tokens="null"><span
                                                               class="text">Business</span><span
                                                               class="glyphicon glyphicon-ok check-mark"></span></a>
                                                            </option>
                                                            <option data-original-index="5" value="Civic & Community"><a tabindex="0" class="" data-tokens="null"><span
                                                               class="text">Civic &amp;
                                                               Community</span><span
                                                                  class="glyphicon glyphicon-ok check-mark"></span></a>
                                                            </option>
                                                            <option data-original-index="6" value="Clubs & Groups"><a tabindex="0" class="" data-tokens="null"><span
                                                               class="text">Clubs &amp;
                                                               Groups</span><span class="glyphicon glyphicon-ok check-mark"></span></a>
                                                            </option>
                                                            <option data-original-index="7" value="Disaster & Emergency"><a tabindex="0" class="" data-tokens="null"><span
                                                               class="text">Disaster & Emergency</span><span
                                                               class="glyphicon glyphicon-ok check-mark"></span></a>
                                                            </option>
                                                            <option data-original-index="8" value="Education"><a tabindex="0" class="" data-tokens="null"><span
                                                               class="text">Education</span><span
                                                               class="glyphicon glyphicon-ok check-mark"></span></a>
                                                            </option>
                                                            <option data-original-index="9" value="Environment"><a tabindex="0" class="" data-tokens="null"><span
                                                               class="text">Environment</span><span
                                                               class="glyphicon glyphicon-ok check-mark"></span></a>
                                                            </option>
                                                            <option data-original-index="10" value="Government"><a tabindex="0" class="" data-tokens="null"><span
                                                               class="text">Government</span><span
                                                               class="glyphicon glyphicon-ok check-mark"></span></a>
                                                            </option>
                                                            <option data-original-index="11" value="Health & Wellness"><a tabindex="0" class="" data-tokens="null"><span
                                                               class="text">Health &amp;
                                                               Wellness</span><span
                                                                  class="glyphicon glyphicon-ok check-mark"></span></a>
                                                            </option>
                                                            <option data-original-index="12" value="Holiday & Seasonal"><a tabindex="0" class="" data-tokens="null"><span
                                                               class="text">Holiday &amp;
                                                               Seasonal</span><span
                                                                  class="glyphicon glyphicon-ok check-mark"></span></a>
                                                            </option>
                                                            <option data-original-index="13" value="Home & Family"><a tabindex="0" class="" data-tokens="null"><span
                                                               class="text">Home &amp;
                                                               Family</span><span class="glyphicon glyphicon-ok check-mark"></span></a>
                                                            </option>
                                                            <option data-original-index="14" value="Other"><a tabindex="0" class="" data-tokens="null"><span
                                                               class="text">Other</span><span
                                                               class="glyphicon glyphicon-ok check-mark"></span></a>
                                                            </option>
                                                            <option data-original-index="15" value="Parks & Nature"><a tabindex="0" class="" data-tokens="null"><span
                                                               class="text" val>Parks &amp;
                                                               Nature</span><span class="glyphicon glyphicon-ok check-mark"></span></a>
                                                            </option>
                                                            <option data-original-index="16" value="Personal Events"><a tabindex="0" class="" data-tokens="null"><span
                                                               class="text">Personal
                                                               Events</span><span class="glyphicon glyphicon-ok check-mark"></span></a>
                                                            </option>
                                                            <option data-original-index="17" value="Politics"><a tabindex="0" class="" data-tokens="null"><span
                                                               class="text">Politics</span><span
                                                               class="glyphicon glyphicon-ok check-mark"></span></a>
                                                            </option>
                                                            <option data-original-index="18" value="Real Estate"> <a tabindex="0" class="" data-tokens="null"><span
                                                               class="text">Real
                                                               Estate</span><span class="glyphicon glyphicon-ok check-mark"></span></a>
                                                            </option>
                                                            <option data-original-index="19" value="Religion & Spirituality"><a tabindex="0" class="" data-tokens="null"><span
                                                               class="text">Religion &amp;
                                                               Spirituality</span><span
                                                                  class="glyphicon glyphicon-ok check-mark"></span></a>
                                                            </option>
                                                            <option data-original-index="20" value="Senior Services"><a tabindex="0" class="" data-tokens="null"><span
                                                               class="text">Senior
                                                               Services</span><span
                                                                  class="glyphicon glyphicon-ok check-mark"></span></a>
                                                            </option>
                                                            <option data-original-index="21" value="Sports & Recreation"><a tabindex="0" class="" data-tokens="null"><span
                                                               class="text">Sports &amp;
                                                               Recreation</span><span
                                                                  class="glyphicon glyphicon-ok check-mark"></span></a>
                                                            </option>
                                                            <option data-original-index="22" value="Technology & Computing"><a tabindex="0" class="" data-tokens="null"><span
                                                               class="text">Technology
                                                               &amp; Computing</span><span
                                                                  class="glyphicon glyphicon-ok check-mark"></span></a>
                                                            </option>
                                                            <option data-original-index="23" value="Travel"><a tabindex="0" class="" data-tokens="null"><span
                                                               class="text">Travel</span><span
                                                               class="glyphicon glyphicon-ok check-mark"></span></a>
                                                            </option>
                                                            <option data-original-index="24" value="Video Gaming"><a tabindex="0" class="" data-tokens="null"><span
                                                               class="text">Video
                                                               Gaming</span><span class="glyphicon glyphicon-ok check-mark"></span></a>
                                                            </option>
                                                         </select>
                                                      </div>
                                                   </div>
                                 ...
                                 <div class="spacer"></div>
                                 <div class="col-xs-10">
                                    <button class="btn btn-lg btn-wide btn-green no-animate kalubinding">Save and
                                    Continue</button>
                                 </div>
                              ...
                              <div id="wizardStepContainer" class="col-xs-12">
                                 <form >
                                    <div  class="kaluscope">
                                                      ...
                                                      <table class="table table-bordered sTable kalustyle:w2.style.themed.table;"
                                                         ...
                                                         <thead>
                                                            <tr class="cleared">
                                                               ...
                                                               <th class="cleared">
                                                                  <span class="pull-right">
                                                                     <div id="open-modal7" class="btn btn-orange Click-here">
                                                         ...
                                                         <tbody class="black-shadow-active">
                                                            ...
                                                            <tr class="kaluscope">
                                                               @if($publish['tslot']==null)
                                                               <td class="col-xs-4"
                                                                  style="background-color: transparent; border-color: rgb(255, 255, 255); color: rgb(255, 255, 255);">
                                                                  {{$publish['lslot']}}&nbsp;&nbsp;(Location:-{{$publish['location']}})
                                                               </td>
                                                               @else
                                                               <td class="col-xs-4"
                                                                  style="background-color: transparent; border-color: rgb(255, 255, 255); color: rgb(255, 255, 255);">
                                                                  {{$publish['tslot']}}&nbsp;&nbsp;(Location:-{{$publish['location']}})
                                                               </td>
                                                               @endif
                                                               <td class="table-wrapper">
                                                                  <table class="table">
                                                                     <tbody>
                                                                        <?php $time= explode(',',  $publish['time']); ?>
                                       ...
                                       <div class="spacer" ></div>
                                       <div class="col-xs-10">
                                          <button type="submit" class="btn btn-lg btn-wide btn-green no-animate kalubinding">Save and
                                          Continue</button>
                                       </div>
                                       <div class="col-xs-2 text-right">
                                       </div>
                           ...
                           <div id="Lon25" class="tabcontent active">
                              ...
                              <div class="row">
                                 <div class="col-md-5 col-lg-5 col-sm-12">
                                    <img src="slot/images/img.jpg" alt="" style="width:100%;">
                                 </div>
                             ...
                             <table class="table table-bordered sTable kalustyle:w2.style.themed.table;"
                              ...
                              <br>
                              <a href="/share"><button class="btn btn-lg btn-wide btn-green no-animate kalubinding">Save and
                              Continue</button></a>
                              </form>
                           </div>
                        </div>
