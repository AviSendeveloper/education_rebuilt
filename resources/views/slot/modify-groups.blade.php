                                ...
                                <div id="wizardView" class="kaluscope">
                                    <div id="signupWizardContainer">
                                        <div class="col-xs-12">
                                            <h1 class="hrow wizard-heading kalubinding">Edit Sign Up
                                                <small
                                                    class="h2 text-darkgray fade-in kalubinding kaluscope">-{{$detail['title']}}
                                                </small>
                                            </h1>
                                        </div>
                                        <div class="col-xs-12">
                                            <div class="btn-tabs">
                                                ...
                                                <button class="btn btn-tab kalubinding tablinks active"
                                                    onclick="openCity(event, 'Lon25')">Publish</button>
                                            </div>
                                        </div>
                                        ...
                                        <form action="/modify-design-publish" method="post" enctype="multipart/form-data">
                                            @csrf
                                                ...
                                                <div class="kaluscope">
                                                    ...
                                                    <div class="l-wizard-step-2 kaluscope">
                                                        <div class="kaluscope">
                                                            ...
                                                            <form method="post" action="/modify-design-publish">
                                                                @csrf
                                                                    ...
                                                                    <div class="col-xs-3">
                                                                        <div syle="margin-bottom: 5px;">
                                                                            <input class="tab-a" data-id="tab4"
                                                                                ...
                                                                                value="single_date">
                                                                            <label for="css"><strong
                                                                                    class="kalubinding">Slots Only</strong></label>
                                                                        </div>
                                                                        <p class="smalltext text-muted kalubinding"> For
                                                                                ...
                                                                                <tbody class="black-shadow-active">
                                                                                    ...
                                                                                    <tr style="height:50px;"
                                                                                        ...
                                                                                        <td class="tcell ng-style:w2.style.themed.td; borderless-l action-icon-wrap ng-scope"
                                                                                            ...
                                                                                            <span
                                                                                                class="no-animate pull-right ng-scope">
                                                                                                <a href="/edit-date-modify/{{$adddates['id']}}"
                                                                                        ...
                                                                                        <td class="table-wrapper ng-scope"
                                                                                            ...
                                                                                            <table class="table">
                                                                                                <tbody>
                                                                                                    ...
                                                                                                    <span class="no-animate pull-right ng-scope">
                                                                                                        <a href="/edit-rsvp-modify/{{$addslots['id']}}" class="tool-icon-link pull-right">
                                                                                ...
                                                                                <tbody class="black-shadow-active">
                                                                                    ...
                                                                                    <tr class="kaluscope">
                                                                                        <td
                                                                                            ...
                                                                                            <span
                                                                                                class="no-animate pull-right ng-scope">
                                                                                                <a href="/edit-rsvp-modify/{{$addslots['id']}}"
                                                                                                    class="tool-icon-link pull-right">
                                                                                                    <span
                                                                                                        class="glyphicon glyphicon-pencil table-icon mono ng-style:w2.style.themed.icon;"
                                                                                                        alt="Edit date/location"
                                    ...
                                    <div id="Lon23" class="tabcontent" style="display: none;">
                                        <div id="wizardStepContainer" class="col-xs-12" data-ng-show="w0.initialized">
                                            <form method="post" action="/modify-design-publish">
                                                @csrf
                                                <input type="hidden" name="setting_id" value="{{$detail['id']}}">
                                                                        ...
                                                                        <span data-ng-if="!w3.isEmailRequired()"
                                                                            ...
                                                                            <select name="email" id="emailrequired"
                                                                                ...
                                                                                <option label="Required"
                                                                                    value="Required"
                                                                                    @if($setting['email']=='Required' )
                                                                                    selected="" @endif>Required
                                                                                </option>
                                                                                <option label="Optional"
                                                                                    value="Optional"
                                                                                    @if($setting['email']=='Optional' )
                                                                                    selected="" @endif>Optional
                                                                                </option>
                                                                            </select>
                                                                        </span>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-xs-2 ask-participants-for-option">
                                                                        <span data-ng-if="!w3.isEmailRequired()"
                                                                            ...
                                                                            <select name="phone" id="emailrequired"
                                                                                ...
                                                                                <option label="Required"
                                                                                    value="Required"
                                                                                    @if($setting['phone']=='Required' )
                                                                                    selected="" @endif>Required
                                                                                </option>
                                                                                <option label="Optional"
                                                                                    value="Optional"
                                                                                    @if($setting['phone']=='Optional' )
                                                                                    selected="" @endif>Optional
                                                                                </option>
                                                                            </select>
                                                                        </span>
                                    ...
                                    <div id="Lon25" class="tabcontent active" style="display: block;">

                                        <div class="row">
                                            <div class="col-md-5 col-lg-5 col-sm-12">
                                                <img src="{{asset('signups/image')}}/{{$detail['image']}}" alt=""
                                                    style="width:100%;">
                                            </div>
                                            <div class="col-md-7 col-lg-7 col-sm-12">
                                                ...
                                                <h2>{{$detail['title']}}</h2>
                                                <p>{{$detail['group']}}</p>
                                                <p>Created by: {{Auth::user()->email}}</p>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td height="35" class="SUGtableheader">Time
                                                            <span class="SUGheaddate">({{$detail['timezone']}})</span>
                                                        </td>
                                                        <td height="35" class="SUGtableheader">
                                                            Available Slot <span class="SUGheaddate"></span>
                                                        </td>
                                                    </tr>
                                                    @foreach ($ss as $day => $add)
                                                    <?php 
                                                    $count = count($add);
                                                          $ls = $count+1; 
                                                   ...
                                                   ?> 
                                                    <tr>
                                                        ...
                                                        <td class="SUGtable" valign="top"
                                                            style="padding-top:10px;padding-bottom:10px;"><span
                                                                class="SUGbigbold">
                                                                ...
                                                                @if(!empty($addsloting))
                                                                    <tr>
                                                                        <td valign="top" width="48%"
                                                                            style="padding-top:10px;">
                                                                            <p class="SUGbigbold hrow">{{$addsloting['tslot']}} </p>
                                                                            <p class="SUGsmall hrow">
                                                                            </p>
                                                                            <p class="SUGcomment hrow">{{$addsloting['help']}}</p>
                                                                        </td>
