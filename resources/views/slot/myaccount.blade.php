                            ...
                            <li id="member-sidebar--menu-messagesid"><a href="#c" data-toggle="tab"
                                    ...
                                    <div class="menu-icon">
                                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink"
                                            xmlns:a="http://ns.adobe.com/AdobeSVGViewerExtensions/3.0/" x="0px" y="0px"
                                            width="23px" height="35px" viewBox="0 0 32 37.75"
                                            style="enable-background:new 0 0 32 37.3;" xml:space="preserve">
                            ...
                            <li id="member-sidebar--menu-messagesid"><a href="#d" data-toggle="tab"
                                    ...
                                    <div class="menu-icon">
                                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink"
                                            xmlns:a="http://ns.adobe.com/AdobeSVGViewerExtensions/3.0/" x="0px" y="0px"
                                            width="26px" height="38px" viewBox="0 0 36 36"
                            ...
                            <li id="member-sidebar--menu-messagesid"><a href="#e" data-toggle="tab"
                                    ...
                                    <div class="menu-icon">
                                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink"
                                            xmlns:a="http://ns.adobe.com/AdobeSVGViewerExtensions/3.0/" x="0px" y="0px"
                                            width="26px" height="41px" viewBox="0 0 31.4 31.6"
                                            style="enable-background:new 0 0 31.4 31.6;" xml:space="preserve">
                            ...
                            <li id="member-sidebar--menu-messagesid"> <a href="#f" data-toggle="tab"
                                    ...
                                    <div class="menu-icon">
                                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink"
                                            xmlns:a="http://ns.adobe.com/AdobeSVGViewerExtensions/3.0/" x="0px" y="0px"
                                            width="26px" height="40px" viewBox="0 0 40 28.6"
                                            style="enable-background:new 0 0 40 28.6;" xml:space="preserve">
                    ...
                    <div class="tabs-left">
                        <div class="tab-content">
                                ...
                                <div class="member-blocks--maincontent-narrow">
                                    <div>
                                        ...
                                        <div class="row">
                                                            ...
                                                            <ol class="breadcrumb ng-isolate-scope"
                                                                ...
                                                                <li data-ng-repeat="crumb in sugBreadcrumb"
                                                                    ...
                                                                    <a data-ng-if="crumb.href !== ''"
                                                                        href="#"
                                                                        class="ng-binding ng-scope">Signups</a>
                                                                </li>
                                                                <li data-ng-repeat="crumb in sugBreadcrumb"
                                                                    data-ng-class="{active: crumb.active}"
                                                                    class="ng-scope active">
                                                                    <span data-ng-if="crumb.href === ''"
                                                                        class="ng-binding ng-scope">Edit Events Created</span>
                                                                </li>
                                                            </ol>
                                                        </div>
                                                        <h1 class="hrow ng-binding">My Signups 
                                           ...
                                           <button type="button" class="btn btn-primary glyphicon glyphicon-question-sign helpme" data-toggle="tooltip" data-placement="top" title="View signups for the events you created">
                                             </button>
                                                                        ...
                                                                        <div class="col-xs-12">
                                                                            <table
                                                                                ...
                                                                                <tbody
                                                                                    ...
                                                                                    class="ng-scope">
                                                                                      @if(!empty($adddate) && $adddate->count())
                            ...
                            <div class="tab-pane" id="b">
                                <form name="createdSignupForm" class="form-horizontal ng-scope ng-pristine ng-valid">
                                    <!-- ngIf: initialized -->
                                    <div class="row ng-scope" data-ng-if="initialized">
                                        <div class="col-sm-12">
                                            <!--
                              use sugPanel to draw the panels
                              1) Recent Activity (not yet implemented)
                              2) Sign Ups I've Created
                              -->
                                            <!-- Sign Ups I've Created -->
                                            <div class="sugPanel" style="margin-top:10px;">
                                                <div class="panel-group" id="signUpsICreated">
                                                    <div class="panel panel-default">
                                                        <div class="panel-heading">
                                                            <div class="row">
                                                                <div class="col-xs-5">
                                                                    <a href="" data-toggle="collapse"
                                                                        data-parent="#signUpsICreated"
                                                                        data-ng-click="setPanelStatus()">
                                                                        <span style="padding-top: 6px;"
                                                                            class="glyphicon glyphicon-minus-sign"></span></a>
                                                                    <!-- ngIf: isSubAdmin -->
                                                                    <!-- ngIf: !isSubAdmin --><span
                                                                        data-ng-if="!isSubAdmin"
                                                                        class="ng-scope"><strong>Sign Ups I've
                                                                            Created</strong></span>
                                                                    <!-- end ngIf: !isSubAdmin -->
                                                                </div>
                                                                <div class="col-xs-4">
                                                        ...
                                                        <div id="signUpLists" class="">
                                                            <div class="panel-body" style="padding-top:5px;">
                                                                <div class="row">
                                                                    <div class="col-xs-12" align="center">
                                                                        <table
                                                                            data-ng-if="filteredCreatedSignUps.length > 0"
                                                                            class="table borderless sTable ng-scope">
                                                                            <tbody>
                                                                           
                                                                            @foreach($signup as $signups)
                                                                            <?php $count = count($signups['adddate']); ?>
                                                                            @if($count!=0)
                                                                                ...
                                                                                <tr class="ng-scope">
                                                                                    ...
                                                                                    <td style="padding-left: 3px;">
                                                                                        <span
                                                                                            class="smalltext text-muted ng-binding"></span><br>
                                                                                        <span ng-if="signup.iscomplete"
                                                                                            popover="rzg"
                                                                                            popover-placement="top"
                                                                                            popover-trigger="mouseenter"
                                                                                            popover-popup-delay="300"
                                                                                            class="ng-scope"><a
                                                                                                href=""
                                                                                                class="text-orange text-underlined">
                                                                                                <strong
                                                                                                    class="ng-binding">{{$signups['title']}}</strong></a></span>
                                                                                    </td>
                                                                                   
                                                                                    <td ng-class="{'evenrow': ($index%2)}"
                                                                                        class="no-wrap">
                                                                                        @foreach($signups['adddate'] as $adddates)
                                                                                        <span
                                                                                            class="smalltext ng-binding">

                                                                                            <span
                                                                                                class="ng-binding ng-scope"><br></span>
                                                                                                {{date('m.d.Y', strtotime($adddates['date']))}}
                                                                                        </span>
                                                                                        @endforeach
                                                                                    </td>
                                                                                    ...
                                                                                    <td width="185"
                                                                                        ...
                                                                                        <div class="row">
                                                                                            <div class="col-xs-3 text-muted ng-scope"
                                                                                                data-ng-if="signup.editable"
                                                                                                style="text-align:center;">
                                                                                                <a href="/edit-created-group/{{$signups['id']}}"
                                                                                                    popover="Edit Sign Up"
                                                                                                    popover-placement="top"
                                                                                                    popover-trigger="mouseenter"
                                                                                                    popover-popup-delay="300"
                                                                                                    class="ng-scope">
                                                                                            ...
                                                                                            <div class="col-xs-3 text-muted ng-scope"
                                                                                                ...
                                                                                                <a
                                                                                                    href="/delete-created-group/{{$signups['id']}}"><i
                                                        ...
                                                        <div class="panel-footer">
                                                            <div class="row">
                                                                <div class="col-xs-5"
                                                                    style="padding-right:0px; padding-top:4px;padding-bottom:8px;">
                                                                    <div
                                                                        class="btn tp-btn-register btn-sm showSignupOptions">
                                                                        Past
                                                                        Sign Ups</div>
                                                                    <a href="/index.cfm?go=c.ArchivedSignUps"
                                                                        class="btn btn-default btn-sm">Archived &amp;
                                                                        Deleted</a>
                                                                </div>
                                                                <!-- ngIf: totalSignupsICreated > frmObj.signUpPerPage -->
                                                            </div>
                                                        </div>
                                                        <!-- end: footer -->
                                                    </div>
                                        ...
                                        <!-- end: Sign Ups I've Created -->
                                    </div>
                            </div>
                            <!-- end ngIf: initialized -->
                            </form>
                        </div>
                                ...
                                <div data-ng-controller="mainMessageCenter" class="ng-scope">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <ul class="nav nav-tabs tab tabbf" role="tablist">
                                                ...
                                                <li data-ng-hide="unsupportedBrowser" class="tablinks"
                                                    ...
                                                    <a href="#/drafts"><span class="glyphicon glyphicon-file"></span>
                                                        Drafts
                                                        &amp; Templates</a>
                                                </li>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div data-ng-view="" class="ng-scope">
                                                    ...
                                                    <div class="row ng-scope">
                                                        <div class="col-xs-12">
                                                            <h2 class="fade-in ng-binding">Account Overview: December
                                                            </h2>
                                                        </div>
                                                    </div>
                                                    <div class="row ng-scope"
                                                        data-ng-if="!ajaxCalls.getMemberEmailLimits">
                                                        <div class="col-xs-5">
                                                            <p><strong>Plan:</strong></p>
                                                            <div class="progress ng-isolate-scope"
                                                                max="memberLimits.dailyLimit"
                                                                ...
                                                                <div class="progress-bar progress-bar-success"
                                                                    ...
                                                                    <span
                                                                        ...
                                                                        class="ng-binding ng-scope">0 / 1,000 email
                                                                        messages
                                                                        used today</span>
                                                                </div>
                                                            </div>
                                                            <div class="progress ng-isolate-scope"
                                                                ...
                                                                <div class="progress-bar progress-bar-success"
                                                                    ...
                                                                    ng-style="{width: (percent < 100 ? percent : 100) + '%'}"
                                                                    aria-valuetext="0%" aria-labelledby="progressbar"
                                                                    style="min-width: 0px; width: 0.3%;"
                                                                    ng-transclude="">
                                                                    <span
                                                                        style="color:black; white-space:nowrap;padding-left:5px;"
                                                                        class="ng-binding ng-scope">3 / 1,000 email
                                                                        messages
                                                                ...
                                                                <div class="col-xs-5">
                                                                    <ul class="nav nav-pills nav-stacked">
                                                                        <li ng-repeat="record in deliveryStats"
                                                                            ...
                                                                            <span
                                                                                class="badge black pull-right">3</span>
                                                                            Total Sent
                                                                        </li>
                                                                        <li ng-repeat="record in deliveryStats"
                                                                            class="ng-binding ng-scope">
                                                                            <span
                                                                                class="badge green pull-right">3</span>
                                                                            Delivered
                                                                        </li>
                                                                        <li ng-repeat="record in deliveryStats"
                                                                            class="ng-binding ng-scope">
                                                                            <span
                                                                                class="badge yellow pull-right">0</span>
                                                                            Bounced
                                                                        </li>
                                                                        <li ng-repeat="record in deliveryStats"
                                                                            class="ng-binding ng-scope">
                                                                            <span
                                                                                class="badge orange pull-right">0</span>
                                                                            Dropped
                                                                        </li>
                                                                        <li ng-repeat="record in deliveryStats"
                                                                            class="ng-binding ng-scope">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <th width="40%"
                                                                            ...
                                                                            <a href=""><strong>Subject</strong>
                                                                                <span
                                                                                    data-ng-show="emailSortBy === 'subject'"
                                                                                    data-ng-class="{'glyphicon glyphicon-chevron-down':!emailSortReverse,'glyphicon glyphicon-chevron-up':emailSortReverse}"
                                                                        ...
                                                                        <th data-ng-click="emailSortBy = 'sentto';emailSortReverse = !emailSortReverse"
                                                                            ...
                                                                            <a href=""><strong>Sent To</strong>
                                                                                <span
                                                                                    data-ng-show="emailSortBy === 'sentto'"
                                                                                    data-ng-class="{'glyphicon glyphicon-chevron-down':!emailSortReverse,'glyphicon glyphicon-chevron-up':emailSortReverse}"
                                                                                    class="ng-hide glyphicon glyphicon-chevron-up"></span></a>
                                                                        </th>
                                    ...
                                    <div id="Paris" class="tabcontent" style="display: none;">
                                        <div data-ng-if="initialized &amp;&amp; signUpList.length" class="ng-scope">
                                            <form name="composeform"
                                                class="form-horizontal ng-pristine ng-valid ng-submitted" role="form">
                                                <div class="row">
                                                    <div class="col-md-12 col-lg-12">
                                                        ...
                                                        <sup>
                                                            <span class="text-orange pointer ng-scope"
                                                                data-ng-if="!complete" data-ng-click="showHelp()">
                                                                <span class="glyphicon glyphicon-question-sign helpme"
                                                                    uib-popover="Click to learn more about composing messages."
                                                                    popover-placement="top" popover-trigger="mouseenter"
                                                                    popover-popup-delay="300"
                                                                    popover-enable="true"></span>
                                                            </span>
                                                        </sup>
                                                            ...
                                                            <div class="col-sm-12">
                                                                <div class="btn-underlines">
                                                                    ...
                                                                    <button data-ng-if="!specificSignup"
                                                                        ...
                                                                        Email Template <img
                                                                            src="slot/images/messageCenter/pro.png"
                                                                            width="24">
                                                                    </button>
                                                                    <button data-ng-if="!specificSignup"
                                                                        class="btn btn-underline ng-scope"
                                                        ...
                                                        <div class="form-horizontal">
                                                            <div class="row ng-scope" data-ng-if="showType == 'email'">
                                                                <div class="col-xs-12">
                                                                    ...
                                                                    <label for="invite" class="radio-css-label">Invite
                                                                        people to
                                                                        a sign
                                                                        up</label>
                                                                </div>
                                                                <div class="col-xs-12">
                                                                    <input type="radio" name="emailType" id="bulk"
                                                                        ...
                                                                        class="css-radio ng-pristine ng-untouched ng-valid"
                                                                        data-ng-change="typeChange()">
                                                                    <label for="bulk" class="radio-css-label">Email
                                                                        people
                                                                        participating
                                                                        in a sign
                                                                        up</label>
                                    ...
                                    <div id="Tokyo" class="tabcontent" style="display: none;">
                                        <div class="ng-scope">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-xs-6">
                                                                            <select id="messagetypes"
                                                                                ...
                                                                                <option value="Invite" selected="">
                                                                                    Invite
                                                                                </option>
                                                                                <option value="Custom Confirmation"
                                                                                    selected="">
                                                                                    Custom
                                                                                    Confirmations
                                                                                </option>
                                                                                <option value="Custom Reminder"
                                                                                    selected="">
                                                                                    Custom
                                                                                    Reminders
                                                                                </option>
                                            ...
                                            <div class="row ng-scope"
                                                data-ng-if="!drafts.length  &amp;&amp; !processing">
                                        ...
                                        <div data-ng-view="" class="ng-scope">
                                            ...
                                            <div class="ng-scope">
                                                ...
                                                <div class="row" ng-hide="showReport">
                                                    ...
                                                    <div class="col-xs-1">
                                                        <span class="pull-right  table-heading--element">
                                                            <a class="dropdown-toggle tool-icon-link"
                                                                data-toggle="dropdown" aria-haspopup="true"
                                                                aria-expanded="true" popover="Settings"
                                                                popover-placement="top" popover-trigger="mouseenter"
                                                                popover-popup-delay="300">
                                                                <span
                                                                    class="glyphicon glyphicon-cog tool-icon mono"></span>
                                                            </a>
                                                            <ul class="dropdown-menu settingsOption"
                                                                ...
                                                                <li>
                                                                    <div class="form-horizontal">
                                                                        <div class="form-group">
                                                                            <label
                                                                                class="col-xs-6 text-left control-label"
                                                                                for="signUpPerPageId">Items/Page</label>
                                                                            <div class="col-xs-6">
                                                                                <input type="number"
                                                                                    name="signUpPerPageId"
                                                                                    id="signUpPerPageId"
                                                        ...
                                                        <table class="table table-hover sTable align-top"
                                                            ...
                                                            <tbody>
                                                                <tr ng-repeat="message in filteredSentMessages"
                                                                    ...
                                                                    <td class="tcell date ng-binding">2021-12-09 1:04pm
                                                                    </td>
                                                                    <td class="tcell">
                                                                        <span data-ng-bind-html="message.subject"
                                                                            ...
                                                                            Invite</span> <br>
                                                                        <span
                                                                            class="verysmalltext text-muted ng-binding">Invite
                                                                            -
                                                                            vb</span>
                                                                    </td>
                                                ...
                                                <span class="verysmalltext text-muted"
                                                    data-ng-show="!showReport &amp;&amp; SentMessages.length">
                                                    <span data-ng-if="dateFormatString != ''"
                                                        class="ng-binding ng-scope">NOTE:
                                                        Dates
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-8">
                                                                        <span
                                                                            data-ng-if="!messageHeader[0].urlid.length"
                                                                            class="ng-binding ng-scope">
                                                                        </span>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-8">
                                                                        <span
                                                                            data-ng-if="messageHeader[0].senttoname != ''"
                                                            ...
                                                            <div class="col-sm-12">
                                                                ...
                                                                <div class="email-preview ng-scope"
                                                                    data-ng-if="!isTextMessage">
                                                                    <div class="link-blocking-cover"></div>
                                                                    <div class="email-content">
                                                                        <div data-ng-bind-html="bodyPreview"
                                                                            align="left" class="ng-binding"></div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div ng-show="activeTab==2" class="ng-hide">
                                                        ...
                                                        <div class="row ng-scope" data-ng-if="!isTextMessage">
                                                            <div class="col-xs-12">
                                                                ...
                                                                <table
                                                                    class="table table-hover sTable align-top ng-hide"
                        ...
                        <div class="tab-pane" id="d">
                            <div class="member-blocks--maincontent-narrow">
                                ...
                                <link href="slot/css/ui-lightness/jquery-ui-1.8.16.custom.css" rel="stylesheet"
                                    type="text/css">
                                <script>
                                $(function() {
                                    $('.noFlashHide').css({
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <ul class="nav nav-tabs" role="tablist" style="font-size:11pt !important;">
                                            <li class="tablinks active" onclick="openCity(event, 'tabb1')"><a
                                                    href="#"><span class="glyphicon glyphicon-list-alt"></span> Sign
                                                    Ups</a></li>
                                ...
                                <div id="tabb1" class="tabcontent" style="display: block;">
                                    ...
                                    <form name="myform" id="myform" action="/index.cfm?go=t.ProcessCustomReport"
                                        ...
                                        <ul>
                                            ...
                                            <label for="allDates_1" class="radio-css-label-mini">Include all dates from
                                                the
                                                selected sign ups</label><br>
                                            <input type="radio" name="allDates" id="allDates_0" value="0"
                                                class="css-radio-mini">
                                            <label for="allDates_0" class="radio-css-label-mini">Only include dates on
                                                the
                                        ...
                                        <h3>Report Style:</h3>
                                        <ul>
                                            <span class="smalltext"><span style="color:red;">Note:</span> If you
                                                collected phone
                                            ...
                                            <div class="indentblock">
                                                <input type="radio" name="style" id="style_count" value="count"
                                                    class="css-radio-mini" checked="">
                                                <label for="style_count" class="radio-css-label-mini">Total Sign Up
                                                    Quantity by
                                                    User</label><br>
                                                ...
                                                <input type="radio" name="style" id="style_slots" value="slots"
                                                    class="css-radio-mini">
                                                <label for="style_slots" class="radio-css-label-mini">List of Sign Ups
                                                    for
                                ...
                                <div id="tabb2" class="tabcontent">
                                    <form name="myform" id="myform" action="/index.cfm?go=t.ProcessSignupStatsReport"
                                        ...
                                        <input name="memberid" id="memberid" type="hidden" value="128801955"><input
                                            name="successpage" id="successpage" type="hidden"
                                            value="t.SignupStatsReport"><input name="failpage" id="failpage"
                                            type="hidden" value="t.SignupStats">
                                ...
                                <div id="tabb3" class="tabcontent">
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <img src="slot/images/PRO-stamp_100.png" height="40"
                                                align="center">&nbsp;&nbsp;&nbsp;<strong>This report is available for
                                                Pro Gold
                                                &amp;
                                    ...
                                    <form name="myform" id="myform"
                                        action="/index.cfm?go=t.ProcessVolunteerReportSlotWindow" method="POST"
                                        ...
                                        <ul>
                                            <input type="radio" name="allDates" value="1" checked="" disabled="">
                                            Include all
                                            dates from
                                            the selected sign ups<br>
                                            <input type="radio" name="allDates" value="0" disabled=""> Only include
                                            dates on the
                                        ...
                                        <div class="indentblock">
                                            <input type="radio" name="showWho" checked="" value="all" disabled="">Show
                                            all users
                                            that
                                            signed up.<br>
                                            <input type="radio" name="showWho" value="group" disabled="">Show all users
                                            from the
                                            group:
                                            disabled
                                            ...
                                            <input type="text" name="totalHours" value="" style="width:25px;"
                                                disabled="">
                                            total hours.
                                        </div>
                                        ...
                                        <input type="button" value="Create Report"
                                            class="button btn btn-success disabled" onclick="javascript:void(0);"
                                            disabled="">
                                        <br><br>
                                        <div class="panel panel-default">
                                            <div class="panel-heading">
                                                <img src="slot/images/PRO-stamp_100.png" height="40"
                                                    align="center">&nbsp;&nbsp;&nbsp;<strong>This report is available
                                                    for Pro
                                                    Gold &amp;
                                                    Platinum subscribers. <a href="/Pro">Learn more</a>.</strong><br
                                                    clear="all">
                        ...
                        <div class="tab-pane" id="e">
                            <div id="memPgCenter" class="member-blocks--maincontent-wide">
                                <script src="slot/js/controllers/tools/proToolsViewController.js"
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <div class="spacer-sm"></div>
                                        <p><strong><img src="slot/images/PRO-stamp_100.png" height="40" align="center">
                                                These
                                ...
                                <div class="row ng-scope" ng-controller="proToolsViewController">
                                    ...
                                    <div class="l-pro-tools--tool">
                                        ...
                                        <div class="l-pro-tools--label">
                                            ...
                                            <div class="sub-text cursor-not-allowed">Set up multiple administrators who
                                                can
                                    ...
                                    S22,50,21.5,50z"></path>
                                        ...
                                        <div class="l-pro-tools--label">
                                            ...
                                            <div class="sub-text cursor-not-allowed">Create a custom landing page to
                                                display
                                    ...
                                    <div class="l-pro-tools--tool">
                                        ...
                                        <div class="l-pro-tools--label">
                                            ...
                                            <div class="sub-text cursor-not-allowed">Sync entire sign ups with
                                                dates/times
                                    ...
                                    <div class="l-pro-tools--tool">
                                        ...
                                        <div class="l-pro-tools--label">
                                            ...
                                            <div class="sub-text cursor-not-allowed">Create custom designs for your sign
                                                ups
                                        ...
                                        <div class="l-pro-tools--label">
                                            <a href=""
                                                ...
                                                <h3 class="hrow no-wrap"><b>Edit People on Sign Ups&nbsp;</b><img
                                                        style="opacity:0" src="slot/images/PRO-stamp_100.svg"
                                                        height="35"></h3>
                                            </a>
                                    ...
                                    <div class="l-pro-tools--tool">
                                        ...
                                        <div class="l-pro-tools--label">
                                            ...
                                            <div class="sub-text cursor-not-allowed">Display multiple tabbed sign ups on
                                                one
                                    ...
                                    <div class="l-pro-tools--tool">
                                        ...
                                        <div class="l-pro-tools--label">
                                            <a href=""
                                                ng-click="proToolsHelper('Print a Sign Up','Print',128801955,'ViewReports')">
                                                <h3 class="hrow no-wrap"><b>Print a Sign Up&nbsp;</b><img
                                                        style="opacity:0" src="slot/images/PRO-stamp_100.svg"
                                                        height="35"></h3>
                                            </a>
                                            <div class="sub-text">Choose a sign up and generate a print out of
                                                participants
                                                and slots.
                                            </div>
                                        </div>
                                    ...
                                    <div class="l-pro-tools--tool">
                                        ...
                                        <div class="l-pro-tools--label">
                                            ...
                                            <div class="sub-text cursor-not-allowed">Integrate SignUpGenius data into
                                                your
                                                own applications.
                                            </div>
                                        </div>
                                    ...
                                    <div class="l-pro-tools--tool">
                                        ...
                                        <div class="l-pro-tools--label">
                                            ...
                                            <div class="sub-text">Create a sign up button to embed on your website for
                                                easy
