...
<div class="wrapper">
    ...
    <div class="box-wrapper">
     <div class="box">
        ...
        @endif
      <h2> Edit Slot</h2> 
        <form id="form" action="/rsvp-edit-submit-modify" method="post">
          @csrf
          <input type="hidden" name="id" value="{{$data['id']}}">
          <div>
          <input  type="text" id="birthdaytime" name="tslot" value="{{$data['tslot']}}" multiple="">
            <label>Title of slot: </label>
          </div>
          <div>
          <input  type="text" id="birthdaytime" name="help" value="{{$data['help']}}" multiple="">
            <label>Help Comment:</label>
          </div>
          <div>
          <input type="number" name="number" value="{{$data['number']}}" class="form-style">
            <label>Number: </label>
          </div>
          
          <input id="submit" type="submit" value="Submit">
          <a href="edit-created-group/{{$data['signup_id']}}" id="submit">Back</a>
        </form>  
  </div>
    </div>
</div>
