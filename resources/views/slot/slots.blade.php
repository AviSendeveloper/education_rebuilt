...
<body>
    ...
    <div class="mainbody">
                        ...
                        <div class="row">
                            <form action="/submit-design" method="post">
                                ...
                                <div id="req_input" class="datainputs">
                                    <input class="date" type="date" id="birthdaytime" name="date[]" value="" multiple required="">
                                    <input type="time" id="birthdaytime1" name="time1[]" value="" multiple required="">
        ...
        <div id="myModal17" class="modal">
            ...
            <div class="ng-scope">
                <input type="checkbox" name="slotdate_0_4"
                    id="slotdate_0_4"
                    class="css-checkbox-chkbx-mini select-dates-dropdown-checkbox ng-pristine ng-untouched ng-valid ng-not-empty">
                <label class="chkbx-css-label-mini ng-binding"
                    for="slotdate_0_4">Thursday, 01/13/2022<br>@
                    5:05 AM - 6:05 AM</label>
            </div>
            <div class="ng-scope">
                <input type="checkbox" name="slotdate_0_5"
                    id="slotdate_0_5"
                    class="css-checkbox-chkbx-mini select-dates-dropdown-checkbox ng-pristine ng-untouched ng-valid ng-not-empty">
                <label class="chkbx-css-label-mini ng-binding"
                    for="slotdate_0_5">Thursday, 01/13/2022<br>@
                    5:05 AM - 6:05 AM</label>
            </div>
                                    ...
                                    <div id="signupWizardContainer">
                                        ...
                                        <div class="col-xs-12">
                                            <div class="btn-tabs">
                                                ...
                                                <button class="btn btn-tab kalubinding disabled">Settings</button>
                                       ...
                                       <form action="/submit-design" method="post" enctype="multipart/form-data">
                                        ...
                                        <div id="Lon11" class="tabcontent active">
                                                ...
                                                <div class="kaluscope">
                                                    ...
                                                    <div class="l-wizard-step-2 kaluscope">
                                                        <div class="kaluscope">
                                                            ...
                                                            <form method="post" action="/submit-design">
                                                                @csrf
                                                                ...
                                                                <div class="kaluscope tab tab-active" data-id="tab1">
                                                                    <div class="row">
                                                                        <div class="col-xs-12">
                                                                                        ...
                                                                                        <td class="tcell ng-style:w2.style.themed.td; borderless-l action-icon-wrap ng-scope"
                                                                                            ...
                                                                                            <span
                                                                                                ...
                                                                                                <a href="/delete-date/{{$adddates['id']}}"
                                                                                                  onclick="return confirm('do you want to delete?')" class="tool-icon-link pull-right">
                                                                                                    <span
                                                                                            ...
                                                                                            <table class="table">
                                                                                                <tbody>
                                                                                                    ...
                                                                                                    <tr style="height:50px;"
                                                                                                        ...
                                                                                                        <a href="/delete-slots-from-date/{{$addslots['id']}}/{{$adddates['id']}}" onclick="return confirm('do you want to delete?')" class="tool-icon-link pull-right">
                                                                                                    ...
                                                                                                    <span class="no-animate pull-right ng-scope">
                                                                                                        <a href="/edit-rsvp/{{$addslots['id']}}" class="tool-icon-link pull-right">
                                                                            ...
                                                                            are shown in
                                                                            '{{$detail['timezone']}}'.<select name="timezone" required="">
                                                                                <option value="{{$detail['timezone']}}">{{$detail['timezone']}}</option>
