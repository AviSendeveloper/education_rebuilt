...
<body>
    ...
    <div class="mainbody">
        ...
        <div id="myModal7" class="modal">
          ...
          <?php $timezone = Session::get('timezone') ?>
                    ...
                    <div class="tabset">
                        ...
                        <div class="tab-panels">
                            ...
                            <section id="marzen" class="tab-panel">
                                <div class="row">
                                   <form action="/update-design-setting" method="post">
                                 @csrf
                                 <input type="hidden" name="detail_add" value="yes">
                                ...
                                <div id="wizardView" class="kaluscope">
                                    ...
                                    <div id="signupWizardContainer">
                                        ...
                                        <div id="myModal2" class="modal">
                                         ...
                                         <form action="/update-design-setting" method="post" enctype="multipart/form-data">
                                          @csrf
                                                        ...
                                                        <div class="kaluscope">
                                                           ...
                                                           <form method="post" action="/setting-save">
                                                               ...
                                                               <div class="row">
                                                                <div class="col-xs-3">
                                                                   <div>
                                                                      <input type="radio" id="css" name="fav_language" required="" value="sort_by_date" @if($field['type_of_sort']=='sort_by_date') checked="" @endif>
                                                                ...
                                                                <div class="col-xs-3">
                                                                   <div>
                                                                      <input type="radio" id="css" name="fav_language" required="" value="sort_by_slot" @if($field['type_of_sort']=='sort_by_slot') checked="" @endif>
                                                                ...
                                                                <div class="col-xs-3">
                                                                   <div>
                                                                      <input type="radio" id="css" name="fav_language" required="" value="slots_only" @if($field['type_of_sort']=='slots_only') checked="" @endif>
                                                                ...
                                                                <div class="col-xs-3">
                                                                   <div>
                                                                      <input type="radio" id="css" name="fav_language" required="" value="single_date" @if($field['type_of_sort']=='single_date') checked="" @endif>
