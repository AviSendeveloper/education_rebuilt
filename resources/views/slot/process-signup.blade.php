...
<body>
    ...
    <section class="process" style="background: #5a6075;">
        <form action="/referral-accepted" method="post">
            @csrf
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td data-column="Job Title"><input type="text" name="comment"></td>
                        <td data-column="Twitter"><input type="number" name="quantity" value="1"></td>
                    </tr>
                ...
                <div class="col-md-8 col-lg-8 col-sm-12">
                        <div class="row">
                            ...
                            <div class="col-md-5 col-lg-5 col-sm-12">
                                <input type="text" class="form-control" name="member_firstname" @if($setting['name']=="Required") placeholder="First name (require*)" @else placeholder="First name (optional*)" @endif @if($setting['name']=="Required") required="" @endif>
                            </div>
                            <div class="col-md-5 col-lg-5 col-sm-12">
                                <input type="text" class="form-control" @if($setting['name']=="Required") placeholder="Last name (require*)" @else placeholder="Last name (optional*)" @endif name="member_lastname" @if($setting['name']=="Required") required="" @endif>
                            </div>
                        </div>
                        <br>
                        <div class="row">
                            ...
                            <div class="col-md-10 col-lg-10 col-sm-12" >
                                <input type="phone" name="member_phone" class="form-control" @if($setting['phone']=="Required") placeholder="Enter your phone number (require*)" @else placeholder="Enter your phone number (optional*)" @endif @if($setting['phone']=="Required") required="" @endif>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10 col-lg-10 col-sm-12" >
                                <input type="email" name="member_email" class="form-control" @if($setting['email']=="Required") placeholder="Enter your email (require*)" @else placeholder="Enter your email (optional*)" @endif @if($setting['email']=="Required") required="" @endif>
                            </div>
                        ...
                        @endif
                        <br>
                        <button type="submit" class="tp-btn-register">Sign Up</button>
                        <br>
                        <br>
       ...
       <div class="modal-body">
           ...
           <form method="post" action="/register" onsubmit="return validation()">
               ...
               <div class="form-group row">
                     <div class="col-md-6">
                         <input type="text" name="firstname" class="form-control hei" id="firstname" aria-describedby="emailHelp" placeholder="Enter firstname" >
                         <span id="first" style="color:red"></span>
                         <br>
                     </div>
                     <div class="col-md-6">
                         <input type="text" name="lastname" class="form-control hei" id="lastname" aria-describedby="emailHelp" placeholder="Enter lastname" >
                         <span id="last" style="color:red"></span>
                         <br>
                     </div>
                     <div class="col-md-6">
                         <input type="email" name="email" class="form-control hei" id="email" aria-describedby="emailHelp" placeholder="Enter email" >
                    ...
                    <div class="col-md-6">
                        <input type="text" name="title" class="form-control hei" id="title" aria-describedby="emailHelp" placeholder="Title: Parent, Teacher, Educator etc." >
                        <br>
                    </div>
               ...
               <div style="text-align: center;">
                   <button name="submit" id="submit" style="border: none;background: transparent;"><a
                           class="tp-btn-register "
...
<script type="text/javascript">
    function validation(){
       ...
       alert(email)
       if(firstname == ""){
            document.getElementById('first').innerHTML = "**please fill the Firstname field";
            return false;
        }
        
        if(lastname == ""){
            document.getElementById('last').innerHTML = " **Please fill the Lastname field";
            return false;
        }
        
        if(email == ""){
            document.getElementById('emailM').innerHTML = " **Please fill the Email field";
            return false;
        }
