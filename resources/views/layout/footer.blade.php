      ...
      <div class="row footer_inner">
          ...
          <div class="col-md-3 col-lg-3 col-sm-12 col-xs-12">
              <div  class="footer_main_box">
                  <h2>Menu</h2>
                  <ul>
                      <li><a href="/question-index">Ask a Question</a></li>
                      <li><a  href="/talent-hub">Helpful Resources</a></li>
                  </ul>
              </div>
          </div>
          <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
              <div class="footer_main_box contact_footer_box" style="float: right;">
                  <h2>Contact Us</h2>
                  <p class="message">
                      support@parentteacherhub.com </p>
  ...
  <div  class="copy_right">
      <div class="container">
          <div class="copy_right_inner">
              <p>© 2021 Parent Teacher Hub. All rights reserved.</p><a
                   href="#"></a>
          </div>
      </div>
  </div>
        ...
        <div class="modal-body">
            ...
            <form method="post" action="/register" onsubmit="return validateForm()">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input type="text" name="title" class="form-control hei" id="title" aria-describedby="emailHelp"
                            placeholder="Title: Parent, Teacher, Educator etc." required>
                        <br>
                    </div>
                ...
                <div style="text-align: center;">
                    <button style="border: none;background: transparent;"><a
                            class="btn btn-teal btn-normal Button-module_btn_1JCnt Button-module_teal_298Cb "
                            style="width: 115px;">Register1111</a></button>
                </div>
                <br>
                <div class="d-flex justify-content-center modal-bottom-links">
                    By joining, you agree to the <a href="/trems-conditions" class="ml-2"
                        style="margin-right:5px;"> Terms and Conditions </a> and <a href="/privacy-policy"
                        class="ml-2"> Privacy Policy</a>
                </div>
        ...
        <div class="modal-body">
            ...
            <form method="post" action="/register" onsubmit="return validateForm()">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input type="text" name="title" class="form-control hei" id="title"
                            aria-describedby="emailHelp" placeholder="Title: Parent, Teacher, Educator etc." required>
                        <br>
                    </div>
                ...
                <div style="text-align: center;">
                    <button style="border: none;background: transparent;"><a
                            class="btn btn-teal btn-normal Button-module_btn_1JCnt Button-module_teal_298Cb "
                            style="width: 115px;">Register11111</a></button>
                </div>
                <br>
                <div class="d-flex justify-content-center modal-bottom-links">
                    By joining, you agree to the <a href="/trems-conditions" class="ml-2">Terms of Service
                    </a> and <a href="/privacy-policy" class="ml-2"> Privacy Policy</a>
                </div>
