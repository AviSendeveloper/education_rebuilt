            ...
            <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    ...
                    <div class="modal-body">
                        <form action="/add-question-category" method="post">
                            @csrf
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <div class="row m-t-30">
                            <div class="col-md-12">
                            <button type="button" class="btn btn-danger float-right" data-toggle="modal" data-target="#exampleModal" data-whatever="@getbootstrap" style="margin-bottom: 20px;">Add Question Category</button>
                                <!-- DATA TABLE-->
                                    ...
                                    <table class="table table-borderless table-data3">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$categorie['url']}}</td>
                                                <td>
                                                    <a href="/delete-question-category/{{$categorie['id']}}"><i class="fas fa-trash"></i></a>&nbsp;&nbsp;
                                                    <a href="/edit-question-category/{{$categorie['id']}}"><i class="fas fa-edit"></i></a>
                                                </td>
                                            </tr>
                                           @endforeach
                                        </tbody>
