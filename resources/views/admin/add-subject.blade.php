                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <div class="row m-t-30">
                            <div class="col-md-12">
                                <!-- search start -->
                                <form method="post" action="/search-admin-subject">
                                    @csrf
                                    <div class="wrap">
                                       <div class="search">
                                    ...
                                    <table class="table table-borderless table-data3">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$item['slug']}}</td>
                                                <td>
                                                    <a href="/delete-subject/{{$item['id']}}" onclick="return confirm('Are you sure, you want to delete this content?')"><i class="fas fa-trash"></i></a>&nbsp;&nbsp;
