                                                ...
                                                <tr>
                                                   ...
                                                   <td width="48%">
                                                      <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                         <tbody>
                                                            <tr height="60">
                                                               <td valign="middle"><a href="https://www.parentteacherhub.com" target="_blank" style="cursor: pointer"><img src="https://education.workstream.club/_next/static/img/logo.png" width="160" height="42" border="0" alt="parentteacherhub"> </a></td>
                                                            </tr>
                                                         </tbody>
                                                      </table>
                                                   </td>
                                                   ...
                                                   <td width="84%" style="color: rgba(0, 0, 0, 1); font-size: 18px; text-align: left; font-family: helvetica, arial, sans-serif; line-height: 27px">
                                                      <table border="0" width="100%" cellspacing="0" cellpadding="0">
                                                         <tbody>
                                                            <tr>
                                                               <td align="center">
                                                                  <p style="font-size: 32px; font-weight: bold; line-height: 30px; margin: -20px 0 0">Thank you, {{$firstname}} {{$lastname}} </p>
                                                                  <p style="line-height: 30px; font-size: 16px">You responded 'Yes' to {{$signup['title']}}.</p>
