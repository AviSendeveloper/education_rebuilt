                        ...
                        <div class="search-module_searchResults_1cQN6">
                                            ...
                                            <div class="SearchBar-module_search-form_3O6b_ form">
                                                ...
                                                <div class="col-md-2 col-lg-2 col-sm-12">
                                                    <button style="border: none;background: transparent;">
                                                        @if (Auth::check())
                                                            <a href="#" data-id="model" data-target="#mymodel" class="btn btn-teal btn-normal Button-module_btn_1JCnt Button-module_teal_298Cb">Add Talent</a></button>
                                                        @else
                                                            <a href="#" id="modalBtn14" class="btn btn-teal btn-normal Button-module_btn_1JCnt Button-module_teal_298Cb">Add Talent</a></button>
                                                        @endif
                                                </div> 
                            ...
                            <div class="search-module_tabs_B0z_I" role="navigation">
                                <div class="HorizontalTabs-module_TabsHorizontal_3pM5Z">
                                    ...
                                    @endif
                                    {{-- <a href="#"
                  class="Tab-module_tab_2XYb6 Tab-module_selected_2-tSf"><span>Printable Worksheets</span></a> --}}
                                    <!--@if (Auth::check())-->
                                    <!--<a href="#" data-id="model" data-target="#mymodel"-->
                                    <!--    class="Tab-module_tab_2XYb6 Tab-module_selected_2-tSf"><span>Add-->
                                    <!--        Talents</span></a>-->
                                </div>
                                <!--@endif-->
                            </div>
                   ...
                   <a href="javascript:void(0);" class="ml-2">Register</a></div>
                        ...
                        <div class="SearchFilters-module_container_2SNWX">
                            <div class="FacetsMobileBtn-module_container__uS19"><button
                                    class="btn btn-tertiary btn-normal Button-module_btn_1JCnt Button-module_tertiary_EUghB FacetsMobileBtn-module_button_3xHjO"><i
                                        class="edicons-module_icon_1tWkL edicon icon-plus-circled FacetsMobileBtn-module_plusIcon_2-vmn"
                                        role="img">&#xe81d;</i>Filters</button></div>
                                ...
                                <div class="team row">
                                    @foreach($data as $item)
                                        ...
                                        <div class="col-md-3 col-lg-3 col-sm-6 ">
                                            ...
                                            <div>
                                                <a href="/user-upload-details/{{$item->id}}">
                                                <div class="grid gapp">
                                            ...
                                            @if (isset(Auth::User()->id))
                                                @if (Auth::User()->id == $item->user_id)
                                                    <a href="/delete-user-subject/{{$item->id}}" onclick="return confirm('Are you sure, you want to delete this content?')"><div class="delete"> <i class="fas fa-trash-alt"></i></div></a>
                                                @endif
                                            @endif
                                        </div>
                                    @endforeach
