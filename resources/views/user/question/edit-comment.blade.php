...
<section>
    <div class="container">
        <div class="detal">
            <h2 style="color:#2257DE !important">Edit Comment</h2>
            <form action="/edit-user-comment" method="post" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="comment_id" value="{{ $commentDetails['id'] }}">
                <div class="form-group">
                    <label class="profile_details_text">Comment:</label>
                    <textarea name="comment" class="form-control ckeditor" required="">{!! $commentDetails['comment'] !!}</textarea>
                </div>
                <br>
