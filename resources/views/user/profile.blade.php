...
<section>
    <div class="container">
        <div class="detal">
            <h2 style="color:#2257DE !important">Edit Personal Information</h2>
            <form action="/edit-profile-upload" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="title" class="form-control" value="{{Auth::User()->title}}" placeholder="Title: Parent, Teacher, Educator etc." required="">
                </div>
                <br>
                <div class="form-group">
                    <label for="exampleFormControlFile1">Upload Dispay Picture</label>
                ...
                <button type="submit" style="border: none;background: transparent;"><a
                           ...
                           style="width: 115px;">Upload</a></button>
